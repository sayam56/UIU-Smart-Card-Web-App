...
<body>
	<?php
            ...
            if ($email == 'admin' || $email == 'fillup') {
            	try{
		                $sqlquery="SELECT * from superuser where su_name= '".$email."' and su_password= '".$password."' ";
						...
						while( $row>0) {
				 			 	...
				 			 	$row1= $object->fetchAll();
										foreach ($row1 as $key) {
	            							...
	            							$_SESSION["running_trimester"]=$key[9];
