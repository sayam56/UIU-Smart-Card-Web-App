...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 16, 2020 at 07:33 PM
...
('CSI 227 C', 'F01192138', 11163078, '2020-09-18', '2020-09-17 19:41:31'),
('CSI 227 C', 'F01192138', 11163071, '2020-09-18', '2020-09-17 19:42:16'),
('CSI 311 B', 'F01192138', 11163071, '2020-09-17', '2020-09-17 22:00:44'),
('CSI 311 B', 'F01192138', 11163071, '2020-09-18', '2020-09-17 22:01:17'),
('CSI 311 B', 'F01192138', 11171327, '2020-09-18', '2020-09-17 22:01:21'),
('CSI 311 B', 'F01192138', 11172070, '2020-09-18', '2020-09-17 22:01:39'),
('CSI 311 B', 'F01192138', 11163075, '2020-09-18', '2020-09-17 22:02:30'),
('CSI 311 B', 'F01192138', 11163075, '2020-09-16', '2020-09-23 15:28:44');
...
(122, 'F01192138', 'CSI 311 B', '2020-09-18', 'true'),
(123, 'F01192138', 'CSI 311 B', '2020-09-18', 'false'),
(124, 'F01192138', 'CSI 311 B', '2020-09-18', 'true'),
(125, 'F01192138', 'CSI 311 B', '2020-09-18', 'true'),
(126, 'F01192138', 'CSI 311 B', '2020-09-18', 'false'),
(127, 'F01192138', 'CSI 311 B', '2020-09-18', 'true'),
(128, 'F01192138', 'CSI 311 B', '2020-09-18', 'false'),
(129, 'F01192138', 'CSI 311 B', '2020-09-18', 'true'),
(130, 'F01192138', 'CSI 311 B', '2020-09-18', 'false'),
(131, 'F01192138', 'CSI 311 B', '2020-09-18', 'true'),
(132, 'F01192138', 'CSI 311 B', '2020-09-18', 'false'),
(133, 'F01192138', 'CSI 311 B', '2020-09-18', 'true'),
(134, 'F01192138', 'CSI 311 B', '2020-09-18', 'false');
...
(283, 1, 1020, '8a99a6865cd802968d024b8322d9ee', '', 'pending');
...
CREATE TABLE `student` (
  ...
  `running_trimester` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `student` (`s_id`, `s_tag`, `s_name`, `s_email`, `s_password`, `s_department`, `s_batch`, `s_phone`, `s_photo`, `running_trimester`) VALUES
(11162009, 'B8ED5C19', 'Arafat Hossain Kishor', 'ahkishor93.ahk@gmail.com', '1234', 'CSE', 162, 1635662133, 'res/userProfile/kishor.jpg', '202'),
(11163071, 'B7ED4C19', 'Ali Iktider Sayam', 'asayam163071@bscse.uiu.ac.bd', '1234', 'CSE', 163, 1721716139, 'res/userProfile/sayam.jpg', '202'),
(11163075, 'B7ED4C29', 'Kazi Muhibul Alam', 'anik06081995@gmail.com', '1234', 'CSE', 163, 1756013171, 'res/userProfile/anik.jpg', '202'),
(11163078, '0EEF4A12', 'Fatema Binte Iqbal', 'fiqbal163078@bscse.uiu.ac.bd', '1234', 'CSE', 163, 1831461981, 'res/userProfile/fatema.jpg', '202'),
(11171327, 'BB09101C', 'FARZANA SULTANA SOHA', 'fsulatana@gmail.com', '1234', 'CSE', 171, 1777660829, 'res/userProfile/soha.jpg', '202'),
(11172070, '0EEF3A1A', 'Md. Akib Al Jawad Arnob', 'akibaljawadarnob@gmail.com', '1234', 'CSE', 172, 1521418857, 'res/userProfile/arnob.jpg', '202'),
(11172085, 'D7FG7C38', 'taskia taher', 'toyshi172085@bscse.uiu.ac.bd', '1234', 'CSE', 172, 1710203047, NULL, '202');
...
CREATE TABLE `studentjcourse` (
  `s_id` int(100) NOT NULL,
  `c_code` varchar(100) NOT NULL,
  `offered_trimester` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `studentjcourse` (`s_id`, `c_code`, `offered_trimester`) VALUES
(11163071, 'MATH 003', '201'),
(11172070, 'MATH 205', '202'),
(11163071, 'CSI 321', '201'),
(11163071, 'CSI 322', '201'),
(11163071, 'Math 201', '202'),
(11163071, 'CSI 415', '201'),
(11172070, 'CSI 411', '202'),
(11172070, 'CSI 341', '202'),
(11172070, 'CSI 342', '202'),
(11171327, 'CSI 423', '202'),
(11171327, 'CSI 424', '202'),
(11171327, 'CSE 465', '202'),
(11163071, 'CSI 311', '202'),
(11172070, 'CSI 311', '202'),
(11171327, 'CSI 311', '202'),
(11172070, 'CSI 312', '202'),
(11163071, 'CSI 312', '202'),
(11163075, 'CSI 321', '202'),
(11172070, 'CSI 321', '202'),
(11172070, 'CSI 227', '202'),
(11163078, 'CSI 227', '202'),
(11163071, 'CSI 227', '202'),
(11163075, 'CSI 227', '202'),
(11162009, 'CSI 227', '202'),
(11171327, 'CSI 227', '202'),
(11163075, 'CSI 311', '202'),
(11162009, 'CSI 311', '202');
...
INSERT INTO `superuser` (`su_id`, `su_name`, `su_password`) VALUES
(1, 'Admin', 'admin'),
(2, 'Fillup', '1234');
...
(450, 1, 20, 'Alu Bhaji', 50, 100, 1, '8a99a6865cd802968d024b8322d9ee'),
(451, 1, 7, 'Apple Juice', 70, 100, 1, '8a99a6865cd802968d024b8322d9ee'),
(452, 1, 11, 'Biriyani', 180, 46, 5, '8a99a6865cd802968d024b8322d9ee');
...
('58156b3e0214b2e7d011d37fa05f27', '09eace7e', 550, 'payment', 1),
...
--
ALTER TABLE `attendance_state`
  MODIFY `attStateID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
...
--
ALTER TABLE `payment_state`
  MODIFY `payment_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=284;
...
--
ALTER TABLE `superuser`
  MODIFY `su_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `temp_transaction`
--
ALTER TABLE `temp_transaction`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=453;
